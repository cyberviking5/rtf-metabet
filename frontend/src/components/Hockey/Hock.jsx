  ...
  return (
    <div>
      ...
      <Modal  token_id={id} open={isOpen} onClose={() => setIsOpen(false)}></Modal>
        ...
        <div className='g3'>
        <div className='g-butt'><p>Team1 will win ?</p><button onClick={()=>{setflag('1');toast.success("Response recorded")}}>Yes</button><button onClick={()=>{toast.success("Response recorded")}}>No</button></div>
